...
| `scaffold/pipeline.jac` (full corpus merge) | not run yet: needs memory headroom. The corpus clone is the sibling repo `jac-data-gen/` (next to this repo's root) @ `c95b7563` |
