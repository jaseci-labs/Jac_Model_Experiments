...
2026-07-18. Companion to design.md (spec) and implementation-plan.md (Tasks 1-19). Verdict computed by `03-new/cpt_train/eval_v2/acceptance_readout.py`, recorded at `03-new/results/cpt-v2/acceptance.json`.
