...
*Historical design doc from 04-cpt-sft (deleted 2026-09-11). Paths below refer to 04's tree. The live code is `08-nitin-new2-ds/spectrum_probe/spectrum/`; how to use it is in [../PLAYBOOK.md](../PLAYBOOK.md) step 1.*
