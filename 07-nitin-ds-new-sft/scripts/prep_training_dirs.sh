...
#
#     stock_probe/configs/sft.yaml            data: ".../07-nitin-ds-new-sft/dataset/sft"
#     spectrum_probe/spectrum/configs/sft_spectrum.yaml   (same)
#     run_dpo_nofuse.sh / run_dpo_spectrum.sh  --data ".../07-nitin-ds-new-sft/dataset/dpo"
#
...
EXP="model-experiments/07-nitin-ds-new-sft"
