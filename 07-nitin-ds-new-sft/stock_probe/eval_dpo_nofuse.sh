...
RDIR="${RDIR:-model-experiments/07-nitin-ds-new-sft/stock_probe/results/dpo-nofuse}"
...
TRAIN_RDIR="${TRAIN_RDIR:-model-experiments/07-nitin-ds-new-sft/stock_probe/results/dpo-nofuse}"
