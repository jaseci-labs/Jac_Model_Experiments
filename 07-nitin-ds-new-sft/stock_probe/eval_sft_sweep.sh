...
RDIR="${RDIR:-model-experiments/07-nitin-ds-new-sft/stock_probe/results/sft}"
...
TMPADP="model-experiments/07-nitin-ds-new-sft/stock_probe/adapters/sft-ckpt-eval"
...
TOTAL_ITERS="$(grep -E '^iters:' model-experiments/07-nitin-ds-new-sft/stock_probe/configs/sft.yaml | grep -oE '[0-9]+' | head -1)"
