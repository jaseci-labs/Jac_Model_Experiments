...
RDIR="${RDIR:-model-experiments/07-nitin-ds-new-sft/spectrum_probe/results/sft-spectrum}"
...
TMPADP="model-experiments/07-nitin-ds-new-sft/spectrum_probe/adapters/sft-spectrum-ckpt-eval"
...
echo "and cross-phase vs 06-nitin-ds-sft spectrum SFT-final 636/855 (74.4%) -- the incumbent"
echo "baseline for this phase -- plus 04-cpt-sft fresh spectrum 639/855 for lineage."
echo "-> $RDIR/mcnemar.json (spec.md §7)."
