...
**RESOLVED 2026-09-09/10** by `scripts/pipeline.jac` (verified end-to-end by
...
`spectrum_probe/spectrum/configs/spectrum_layers.json` is copied unchanged
...
`stock_probe/` and `spectrum_probe/` are 07's trees with every
...
3. `spectrum_probe/eval_sft_spectrum.sh:85` and `eval_dpo_spectrum.sh:85`
