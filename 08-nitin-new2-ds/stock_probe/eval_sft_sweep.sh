...
RDIR="${RDIR:-08-nitin-new2-ds/stock_probe/results/sft}"
...
TMPADP="08-nitin-new2-ds/stock_probe/adapters/sft-ckpt-eval"
...
TOTAL_ITERS="$(grep -E '^iters:' 08-nitin-new2-ds/stock_probe/configs/sft.yaml | grep -oE '[0-9]+' | head -1)"
