...
def build_selection_artifact(scan: dict, picks_by_rank: Sequence[int], rule: str,
    ...
    """2-train/spectrum/spectrum_layers.json -- spectrum-plan.md §5.3, frozen once training starts."""
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    ap.add_argument("--selection-out", required=True, help="2-train/spectrum/spectrum_layers.json")
