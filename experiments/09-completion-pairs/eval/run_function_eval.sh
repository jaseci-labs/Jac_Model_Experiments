...
#
#   experiments/09-completion-pairs/eval/run_function_eval.sh [reference] [base] [adapter]
#   (09 default: reference adapter -- base is the same untrained model as 08's, reuse
#    experiments/08-nitin-new2-ds/results/function_v1_test/base; pass `base` to redo it)
