...
*Blog 4 of 4 on the model work behind Jac Model Studio. The other three go deep on [continual pretraining](../model-work/post.md), [layer selection](../fine-tuning-layers-breakthrough/post.md), and [the app](../jms-model-studio/post.md). This one is the map: what we're trying to do, everything we've tried, and where it stands as of early August 2026.*
