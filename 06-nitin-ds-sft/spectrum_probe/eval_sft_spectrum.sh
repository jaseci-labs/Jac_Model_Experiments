...
RDIR="${RDIR:-model-experiments/06-nitin-ds-sft/spectrum_probe/results/sft-spectrum}"
...
TMPADP="model-experiments/06-nitin-ds-sft/spectrum_probe/adapters/sft-spectrum-ckpt-eval"
...
echo "and cross-phase vs 04-cpt-sft fresh spectrum 639/855 -> $RDIR/mcnemar.json (spec.md §7)."
