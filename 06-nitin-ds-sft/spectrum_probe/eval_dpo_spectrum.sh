...
RDIR="${RDIR:-model-experiments/06-nitin-ds-sft/spectrum_probe/results/dpo-spectrum}"
...
TRAIN_RDIR="${TRAIN_RDIR:-model-experiments/06-nitin-ds-sft/spectrum_probe/results/dpo-spectrum}"
