...
RDIR="${RDIR:-model-experiments/06-nitin-ds-sft/stock_probe/results/sft}"
...
TMPADP="model-experiments/06-nitin-ds-sft/stock_probe/adapters/sft-ckpt-eval"
...
TOTAL_ITERS="$(grep -E '^iters:' model-experiments/06-nitin-ds-sft/stock_probe/configs/sft.yaml | grep -oE '[0-9]+' | head -1)"
